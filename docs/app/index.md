...
主要功能按版本整理在[版本 Log](/version-log/)中。当前稳定基线包含 Mermaid 文档模式与代码块预览、源码 / WYSIWYG 记忆、移动端原生选中栏、多格式导出、社区主题与集中偏好设置，以及根据背景改善 Markmap 线段对比度的可访问性处理。
...
外观、编辑器、预览、拼写、全局和快捷键设置统一从“帮助 → 偏好设置”进入；在移动端可以展开对应分类。
