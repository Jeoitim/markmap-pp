...
// 所以挂载时直接转 fixed 锚定到触发按钮上方；窄屏再夹紧回视口内。
function clampPopover(el: HTMLDivElement | null) {
  ...
  if (trigger) {
    ...
    const y = Math.max(margin, t.top - h - 7)
